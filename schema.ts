...
/** An exception that is raised during authentication */
export type InvalidEmailException = {
  __typename?: 'InvalidEmailException';
  /** A message describing why the exception occured */
  message: Scalars['String'];
};
...
export type RevokeCertificateReponse = NotFoundException | RevokeCertificateSuccess;
...
export type UpdateUserResult = InvalidEmailException | User;
